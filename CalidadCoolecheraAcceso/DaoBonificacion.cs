...
namespace CalidadCoolecheraAcceso
{
    public class DaoBonificacion
    {
        ...
        {
            var strSQl = @"INSERT INTO calidad.bonificacion(am_rangoinferior, am_rangosuperior, am_pagobacterias, am_pagofrio, am_valorfriovoluntario, ds_usuariocreacion, ds_equipocreacion, dt_fechacreacion, ds_programacreacion, ds_usuariomodificacion, ds_equipomodificacion, dt_fechamodificacion, ds_programamodificacion) 
                           VALUES (@am_rangoinferior, @am_rangosuperior, @am_pagobacterias, @am_pagofrio, @am_valorfriovoluntario,  @ds_usuariocreacion, @ds_equipocreacion, @dt_fechacreacion, @ds_programacreacion, @ds_usuariomodificacion, @ds_equipomodificacion, @dt_fechamodificacion, @ds_programamodificacion)  ";
